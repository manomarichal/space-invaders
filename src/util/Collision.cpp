...
{
    if (std::dynamic_pointer_cast<objects::shield::Shield>(e2) == nullptr) return false;
    return checkCollision(e1, *e2.get());
}
bool Collision::enemy(const objects::Entity &e1, const std::shared_ptr<objects::Entity> &e2)
{
    if (std::dynamic_pointer_cast<objects::enemies::Enemy>(e2) == nullptr) return false;
    return checkCollision(e1, *e2.get());
}
bool Collision::playership(const objects::Entity &e1, const std::shared_ptr<objects::Entity> &e2)
{
    if (std::dynamic_pointer_cast<objects::playership::PlayerShip>(e2) == nullptr) return false;
    return checkCollision(e1, *e2.get());
}
bool Collision::standardProjectile(const objects::Entity &e1, const std::shared_ptr<objects::Entity> &e2)
{
    if (std::dynamic_pointer_cast<objects::projectiles::standard::StandardProjectile>(e2) == nullptr) return false;
    return checkCollision(e1, *e2.get());
}
bool Collision::standardEnemyProjectile(const objects::Entity &e1, const std::shared_ptr<objects::Entity> &e2)
{
    if (std::dynamic_pointer_cast<objects::projectiles::standard_enemy::StandardEnemyProjectile>(e2) == nullptr) return false;
    return checkCollision(e1, *e2.get());
}
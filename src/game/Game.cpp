...
Game::Game()
{
    ...
    auto ship = std::make_shared<entities::playership::PlayerShip>(screensize::x/2, (screensize::y*9)/10    );
...
void Game::startGame()
{
    window = std::make_unique<sf::RenderWindow>(sf::VideoMode(500, 500), "Space Invaders");
